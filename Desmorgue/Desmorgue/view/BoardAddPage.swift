            ...
            VStack {
                ZStack {
                    ...
                    HStack {
                        ...
                        Button(action: {
                            dao.userProfile.group[dao.userProfile.currentGroup].taskBoard.insert(Task(owner: self.profile, title: self.title, description: self.description, deadline: self.deadline, date: Date(), group: self.profile.group[self.profile.currentGroup]), at: 0)
                            self.isPresented = false
